...
OUT_IMG="/Users/cc/Desktop/GGBOM/xxxx/output/animated_enemies_runtime_verified.png"

echo "🎮 启动 Standalone 游戏验证 4 帧单向怪物动画实机运行..."
