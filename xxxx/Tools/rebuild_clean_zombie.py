...
OUT = ROOT / "output/clean_zombie_result.txt"
...
def log(msg):
    unreal.log(f"[CLEAN_ZOMBIE] {msg}")
    print(f"[CLEAN_ZOMBIE] {msg}", flush=True)
...
def run():
    ...
    is_right = fn("/Script/Engine.KismetMathLibrary.Greater_DoubleDouble", 1380, -120)
    ...
    set_scale_r = fn("/Script/Engine.SceneComponent.SetRelativeScale3D", 1860, -180)
    ...
    set_scale_l = fn("/Script/Engine.SceneComponent.SetRelativeScale3D", 1860, -60)
