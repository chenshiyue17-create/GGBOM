...
OUT = ROOT / "output/boss_v2_result.txt"
...
def run():
    ...
    # 距离门禁: 150.0 (Boss 居高临下后排重砸，绝不踩踏小怪)
    dist_node = fn("/Script/Engine.KismetMathLibrary.Vector_Distance", 700, -80)
    connect(p_loc, "ReturnValue", dist_node, "v1"); connect(self_loc, "ReturnValue", dist_node, "v2")

    is_far = fn("/Script/Engine.KismetMathLibrary.Greater_DoubleDouble", 940, -80)
    connect(dist_node, "ReturnValue", is_far, "A"); set_value(is_far, "B", 150.0)
    ...
    connect(p_loc, "ReturnValue", sub_v, "A"); connect(self_loc, "ReturnValue", sub_v, "B")
    norm_v = fn("/Script/Engine.KismetMathLibrary.Normal", 920, 120); connect(sub_v, "ReturnValue", norm_v, "A")
    break_v = fn("/Script/Engine.KismetMathLibrary.BreakVector", 1140, 120); connect(norm_v, "ReturnValue", break_v, "InVec")
    ...
    move_x = fn("/Script/Engine.Actor.K2_AddActorWorldOffset", 2060, 40); set_value(move_x, "bSweep", "true")
    ...
    move_z = fn("/Script/Engine.Actor.K2_AddActorWorldOffset", 2060, 200); set_value(move_z, "bSweep", "true")
    ...
    abs_x = fn("/Script/Engine.KismetMathLibrary.Abs", 1380, -40); connect(break_v, "X", abs_x, "A")
    abs_z = fn("/Script/Engine.KismetMathLibrary.Abs", 1380, 10); connect(break_v, "Z", abs_z, "A")
    ...
    connect(br_gate, "else", set_fb_slam, "execute"); connect(get_fb, "ReturnValue", set_fb_slam, "self")
