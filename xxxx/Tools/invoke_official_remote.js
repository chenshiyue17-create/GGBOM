...
console.log('🚀 [Node Runner] 准备调用官方 Python 远程执行协议...');

// 编写调用 official_remote_execution.py 的 runner 脚本
const runnerPy = `
import sys
import time
import os
...
fs.writeFileSync('/Users/cc/Desktop/GGBOM/xxxx/Tools/run_ore.py', runnerPy, 'utf8');

try {
    const pythonBin = '/Library/Frameworks/Python.framework/Versions/3.12/bin/python3';
    console.log(`📡 正在通过系统 Python (${pythonBin}) 执行通信...`);
    const output = execSync(`${pythonBin} /Users/cc/Desktop/GGBOM/xxxx/Tools/run_ore.py`, {
        timeout: 10000,
        encoding: 'utf8'
    });
    console.log(output);
