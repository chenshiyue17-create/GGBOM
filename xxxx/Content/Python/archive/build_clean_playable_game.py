...
"""
================================================================================
《GGBOM: 终末医疗兵》全量清洁可控角色与 9:16 正交全景固定视角总装流水线
================================================================================
"""
...
def log(msg: str):
    unreal.log(f"[GGBOM-CleanPlayable] {msg}")
...
def build_medic_pawn():
    log("🔨 重建全新 BP_Player_Medic Pawn (挂载固定全景摄像机 + WASD 平滑移动)...")
...
def assemble_main_stage():
    log("🚀 全量组装 MAP_GGBOM_Main 关卡...")
    ...
    # 唯一主角出生点 (由 GameMode 自动生成并附身 BP_Player_Medic)
